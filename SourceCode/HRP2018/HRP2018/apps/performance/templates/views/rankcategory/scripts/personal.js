(function (scope) {
    ...
    scope.tableFields = [
        ...
        { "data": "rank_content", "title": "${get_res('rank_content_table_header','Đánh giá chung')}" },
        { "data": "total_from", "title": "${get_res('total_from_table_header','Tổng điểm từ')}" },
        { "data": "total_to", "title": "${get_res('total_to_table_header','Tổng điểm đến')}" },
        { "data": "is_change_object", "title": "${get_res('is_change_object_table_header','Thiết lập riêng')}", "format": "checkbox" },
